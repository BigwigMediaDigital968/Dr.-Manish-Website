  ...
  return (
    <>
      <ServiceHero
        ...
        description={
          <>
            Hearing a high-pitched whistle when you breathe in or out? You're
            not alone, and it's not something to ignore. Wheezing happens when
            your airways narrow, swell, or get blocked, making it hard for air
            to flow smoothly. Knowing the cause is the first step to breathing
            easier again. <br /> Dr. Manish Aggarwal, a practicing
            pulmonologist, breaks down the common causes of wheezing in plain,
      ...
      <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 mt-2">
            <div className="flex-1">
              <h2 className="text-2xl sm:text-3xl font-bold text-[#0f172a] mb-6 leading-relaxed">
                What Is Wheezing and What Does the Wheezing Sound While
                Breathing Actually Mean?
              </h2>

              <p className="text-sm sm:text-base text-[#64748b] leading-relaxed mt-4">
                Wheezing is a musical, whistling, or squeaky sound that comes
                from your chest or throat while you breathe. Some people
                describe the wheezing sound while breathing as similar to air
                being squeezed out of a balloon. This sound happens because your
                airways, the small tubes that carry air in and out of your
                lungs, have become tighter than normal.
              </p>

              <p className="text-sm sm:text-base text-[#64748b] leading-relaxed mt-4">
                You may notice the wheezing sound while breathing more clearly
                when you breathe out, but in more serious cases, it can happen
                while breathing in as well. If the wheezing sound while
                breathing is new, sudden, or getting louder, it is a sign that
                something inside your airways needs attention, and it should not
                be ignored.
              </p>
            </div>
        ...
        <section className="pt-12">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="mt-4 text-sm sm:text-base leading-relaxed text-[#64748b]">
              There is not just one reason for wheezing. The causes of wheezing
              can range from mild, temporary issues to conditions that need
              ongoing medical care. Below are the most common causes of wheezing
              that Dr. Manish Aggarwal sees in his clinic every day.
            </p>
            <div className="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                {
                  ...
                  description: (
                    <>
                      This is one of the most well-known causes of wheezing. In
                      asthma, the airways become inflamed and swollen, and the
                      muscles around them tighten. This makes breathing feel
                      like sucking air through a narrow straw, and it is often
                      the main reason for wheezing in both children and adults,
                      especially during cold weather, exercise, or exposure to
                      dust and smoke.
                    </>
                  ),
                  href: "#",
                },
                {
                  ...
                  description: (
                    <>
                      When the tubes carrying air to your lungs get infected,
                      inflamed, and widened over time, wheezing can become a
                      recurring problem. This swelling and narrowing is a common
                      reason for wheezing, and it usually comes along with a
                      persistent cough, mucus, and a tight feeling in the chest.
                    </>
                  ),
                  href: "#",
                },
                {
                  ...
                  description: (
                    <>
                      COPD is a long-term lung condition, usually linked to
                      smoking or long exposure to polluted air, where the
                      airways become damaged over time. It is a serious reason
                      for wheezing in older adults, and it needs proper
                      diagnosis and long-term management from a pulmonologist.
                    </>
                  ),
                  href: "#",
                },
                {
                  ...
                  description: (
                    <>
                      The common cold, flu, and viral chest infections can all
                      lead to swollen airways and mucus buildup, both of which
                      are frequent causes of wheezing, particularly in young
                ...
                },
                {
                  ...
                  description: (
                    <>
                      In some cases, especially in older adults, fluid buildup
                      around or inside the lungs due to heart problems can also
                      be one of the causes of wheezing. This is why a proper
                      checkup is important instead of guessing the reason on
                      your own.
                    </>
                  ),
                  href: "#",
                },
                {
                  ...
                  description: (
                    <>
                      This is more common in small children who may accidentally
                      swallow or inhale a small toy or piece of food. It is a
                      sudden and urgent reason for wheezing that needs emergency
                ...
                },
                {
                  ...
                  description: (
                    <>
                      Sometimes the vocal cords do not open properly while
                      breathing, causing a wheezing sound that is often mistaken
                      for asthma. A pulmonologist can help tell the difference
              ...
              <div className="sm:col-span-2 flex flex-col items-center text-center mx-auto rounded-3xl bg-slate-50 border border-slate-200 p-6 sm:p-8">
                ...
                <p className="mt-2 text-sm text-[#64748b] leading-relaxed">
                  Wheezing lasting more than a week, wheezing along with cough
                  or mucus, wheezing after meals or while lying down, or a
                  family history of asthma or allergies. Book a slot with Dr.
                  Manish Aggarwal for same-day spirometry and next-day allergy
                  testing to pinpoint the exact cause behind your symptoms.
                </p>
                <div className="mt-6">
        ...
        <section className="pt-16">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="mt-4 text-sm sm:text-base leading-relaxed text-[#64748b]">
              Wheezing is not always serious, but it should never be ignored
              completely. A soft wheezing sound while breathing that goes away
              on its own after a cold may not need urgent care. However,
              wheezing can become serious when it is:
            </p>
        ...
        <section className="pt-16">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="mt-4 text-sm sm:text-base leading-relaxed text-[#64748b]">
              If your wheezing keeps coming back, lasts for more than a few
              days, or is affecting your sleep, work, or daily activities, it is
              time to speak with a specialist instead of guessing the reason for
              wheezing on your own. Dr. Manish Aggarwal uses proper lung
              function tests, a detailed health history, and years of clinical
              experience to find the exact cause of wheezing behind your
              symptoms and create a treatment plan suited to you.{" "}
            </p>
              ...
              <div className="relative ">
                <div className="">
                  ...
                  <p className="mt-5 text-sm sm:text-base leading-relaxed text-[#64748b]">
                    Dr. Manish Aggarwal is a practicing pulmonologist who has
                    spent years diagnosing and treating patients with
                    breathing-related conditions, including chronic wheezing,
                    asthma, bronchitis, and COPD. His approach focuses on
                    identifying the actual reason for wheezing in each patient
                    rather than offering generic treatment, using proper
                    diagnostic tools combined with years of clinical experience.
                    Patients trust Dr. Aggarwal for clear explanations, honest
                    guidance, and treatment plans built around their specific
