  ...
  const specialities = [
    {
      ...
      desc: "A thorough, step-by-step workup to identify the exact underlying cause of persistent or long-standing cough, followed by a personalized treatment plan designed for lasting relief and improved quality of life.",
      category: "Pulmonary",
      icon: Wind,
      color: "#1fa8e8",
      badge: "Advanced Care",
    ...
    {
      id: "2",
      title: "Tuberculosis (TB) Diagnosis & Treatment Accurate",
      desc: "Timely diagnosis and complete end-to-end treatment support for TB, including complex drug-resistant cases, delivered under the close supervision of an experienced pulmonology specialist.",
      category: "Pulmonary",
      icon: Activity,
      color: "#0c7dc2",
      badge: "Specialized",
    },
    {
      ...
      desc: " An advanced, minimally invasive ultrasound-guided procedure that allows precise sampling of lung and lymph node tissue, helping ensure faster, more accurate diagnosis and staging",
      category: "Pulmonary",
      icon: Compass,
      color: "#1fa8e8",
      badge: "Expert Care",
    ...
    {
      id: "4",
      title: "Lung Cancer Diagnosis & Management Comprehensive",
      desc: "Evaluation, precise staging, and carefully coordinated management for suspected or confirmed lung cancer, backed by the expertise of the best pulmonologist in Delhi and a multidisciplinary care approach.",
      category: "Pulmonary",
      icon: Layers,
      color: "#0c7dc2",
      badge: "Diagnostic",
    ...
    {
      id: "5",
      title: "Bronchoscopy Services",
      desc: "Direct, high-resolution visual examination of the airways to accurately diagnose and effectively treat a wide range of lung and respiratory conditions.",
      category: "Pulmonary",
      icon: Award,
      color: "#1fa8e8",
    ...
    },
    {
      ...
      desc: "Long-term, personalized management of asthma and chronic obstructive pulmonary disease (COPD), focused on controlling symptoms, reducing flare-ups, and improving day-to-day breathing.",
      category: "Pulmonary",
      icon: Heart,
      color: "#6dbb45",
    ...
    },
    {
      ...
      desc: " Specialized diagnosis and treatment of conditions affecting the pleura, including safe fluid drainage and pleural biopsy procedures performed with precision and care.",
      category: "Pulmonary",
      icon: Moon,
      color: "#6dbb45",
    ...
    },
    {
      ...
      desc: " Complete assessment and treatment of sleep apnea and other sleep-related breathing disorders, including guided sleep study referrals and ongoing follow-up care.",
      category: "Pulmonary",
      icon: Cloud,
      color: "#4d8f2d",
      badge: "Delhi Care",
