...
const pageUrl = `${siteUrl}/procedures/6-minute-walk-test-in-delhi`;

export const metadata: Metadata = {
  title: "6 Minute Walk Test in Delhi | Dr. Manish Aggarwal",
  description:
  ...
  alternates: {
    canonical:
      "https://www.drmanishaggarwal.com/procedures/6-minute-walk-test-in-delhi",
  },
  ...
  openGraph: {
    ...
    description:
      "6 minute walk test (6MWT) in Delhi by Dr. Manish Aggarwal to assess exertional breathlessness & oxygen levels in lung disease. Book your assessment today.",
    url: "https://www.drmanishaggarwal.com/procedures/6-minute-walk-test-in-delhi",
    locale: "en_IN",
    images: [
      {
        url: `${siteUrl}/images/6-minute-walk-test-og.jpg`,
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    description:
      "6 minute walk test (6MWT) in Delhi by Dr. Manish Aggarwal to assess exertional breathlessness & oxygen levels in lung disease. Book your assessment today.",
    images: [`${siteUrl}/images/6-minute-walk-test-og.jpg`],
  },
};
...
const structuredData = {
  ...
  "@graph": [
    {
      "@type": "MedicalWebPage",
      "@id": "https://www.drmanishaggarwal.com/procedures/6-minute-walk-test-in-delhi#webpage",
      "url": "https://www.drmanishaggarwal.com/procedures/6-minute-walk-test-in-delhi",
      "name": "6 Minute Walk Test in Delhi | Dr. Manish Aggarwal",
      "description": "6 minute walk test (6MWT) in Delhi by Dr. Manish Aggarwal to assess exertional breathlessness & oxygen levels in lung disease. Book your assessment today.",
      "inLanguage": "en-IN",
      "isPartOf": {
        "@id": "https://www.drmanishaggarwal.com/#website"
      },
      "about": {
        "@id": "https://www.drmanishaggarwal.com/procedures/6-minute-walk-test-in-delhi#medicaltest"
      },
      "reviewedBy": {
        "@id": "https://www.drmanishaggarwal.com/#physician"
      },
      "mainEntity": {
        "@id": "https://www.drmanishaggarwal.com/procedures/6-minute-walk-test-in-delhi#faq"
      },
      "breadcrumb": {
        "@id": "https://www.drmanishaggarwal.com/procedures/6-minute-walk-test-in-delhi#breadcrumb"
      }
    },
    {
      "@type": "MedicalTest",
      ...
      "description": "The 6 minute walk test measures how well the heart and lungs work together during sustained walking, tracking oxygen levels, heart rate, and breathlessness to assess functional capacity in chronic lung and heart conditions.",
      ...
      "howPerformed": "A pulse oximeter tracks oxygen and heart rate while the patient walks back and forth along a measured corridor at their own pace for six minutes; distance, oxygen drops, and recovery are recorded, taking 20-30 minutes total.",
      "followup": "No special recovery period is needed; Dr. Aggarwal reviews walk distance, oxygen trends, and symptoms to guide diagnosis or treatment, including possible supplemental oxygen needs.",
      "alternateName": "6MWT"
    },
    {
      "@type": "BreadcrumbList",
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 3,
          "name": "6 Minute Walk Test in Delhi",
          "item": "https://www.drmanishaggarwal.com/procedures/6-minute-walk-test-in-delhi"
        }
      ]
    },
    {
