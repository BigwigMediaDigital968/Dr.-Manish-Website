...
const faqs = [
  {
    ...
    answer:
      "Non-small cell lung cancer can be curable, especially when it's diagnosed at an early stage and treated with surgery, sometimes combined with chemotherapy or radiation. In more advanced stages, treatment focuses on controlling the cancer's growth and managing symptoms, though outcomes vary depending on the subtype and how far it has spread.",
  },
  {
    question: "What is the prognosis of non-small cell lung cancer?",
    answer:
      "Prognosis depends largely on the stage at diagnosis, the specific subtype, and how well the patient responds to treatment. Early-stage NSCLC generally has a better outlook than cancer that has spread to other organs. Molecular testing can also reveal targeted treatment options that improve outcomes for certain patients. A Non-Small Cell Lung Carcinoma Specialist can give a more personalised outlook after reviewing your specific test results.",
  },
  {
    question: "How do you treat non-small cell lung cancer?",
    answer:
      "Treatment depends on the stage and subtype of the cancer, and usually involves a combination of surgery, chemotherapy, radiation therapy, targeted therapy, or immunotherapy. Dr. Manish Aggarwal decides the right combination based on detailed imaging, biopsy results, and molecular testing.",
  },
  {
    question: "What is non-small cell carcinoma lung cancer?",
    answer:
      "Non-small cell lung carcinoma is the most common type of lung cancer, making up the large majority of cases. It includes subtypes like adenocarcinoma, squamous cell carcinoma, and large cell carcinoma, and tends to grow and spread more slowly than small cell lung cancer, the other main type.",
  },
  {
    question: "What are the stages of non-small cell lung cancer?",
    answer:
      "NSCLC is generally staged from I to IV, based on the size of the tumour and whether it has spread to lymph nodes or other parts of the body. Stage I is localised to the lung, while Stage IV indicates the cancer has spread to distant organs. Staging plays a major role in deciding the treatment approach.",
  },
  {
    question: "Should I see a specialist if I have a persistent cough?",
    answer:
      "Yes, a cough that lasts more than a few weeks, especially if accompanied by weight loss, blood in the mucus, or chest pain, should be evaluated by a pulmonologist. Early evaluation allows for timely diagnosis, which significantly improves treatment outcomes for lung cancer.",
  },
];
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 mt-2">
            <div className="flex-1">
              ...
              <p className="text-sm sm:text-base text-[#64748b] leading-relaxed mt-4">
                Non-Small Cell Lung Carcinoma is a type of lung cancer that
                develops when cells in the lung tissue grow abnormally and form
                a tumour. It accounts for the large majority of all lung cancer
                cases and grows and spreads more slowly than the other main
                type, small cell lung cancer, which generally gives a wider
                window for effective treatment.
              </p>

              <p className="text-sm sm:text-base text-[#64748b] leading-relaxed mt-4">
                NSCLC includes a few subtypes, such as adenocarcinoma, squamous
                cell carcinoma, and large cell carcinoma, each behaving slightly
                differently. Without proper evaluation and treatment from a
                Non-Small Cell Lung Carcinoma Specialist, the cancer can spread
                to other parts of the body over time.
              </p>
            </div>
        ...
        <div className="flex flex-col lg:flex-row gap-12 pt-16 sm:pt-20">
          ...
          <div className="flex-1">
            ...
            <p className="mt-4 text-sm sm:text-base leading-relaxed text-[#64748b]">
              NSCLC symptoms can be subtle in the early stages and are often
              mistaken for other respiratory conditions. Common signs include:
            </p>
          ...
          <div className="flex-1">
            ...
            <p className="mt-4 text-sm sm:text-base leading-relaxed text-[#64748b]">
              NSCLC develops due to changes in lung cells that lead to
        ...
        <section className="pt-16 sm:pt-20">
          ...
          <p className="mt-4 text-sm sm:text-base leading-relaxed text-[#64748b]">
            Confirming NSCLC and identifying its exact type and stage is
            essential for building the right treatment plan. Dr. Manish Aggarwal
          ...
          <ul className="mt-6 space-y-3">
            {[
              ...
              { name: "PET-CT scan to check the extent of spread" },
              {
                ...
                link: "/procedures/bronchoscopy-in-delhi",
              },
              {
                name: "EBUS (Endobronchial Ultrasound) to examine nearby lymph nodes",
                link: "/procedures/ebus-endobronchial-ultrasound-in-delhi",
              },
              {
                name: "Biopsy for tissue and molecular testing",
                link: "/procedures/pleural-biopsy-in-delhi",
              },
              {
        ...
        <section className="pt-10 sm:pt-16">
          ...
          <div className="mt-4 text-sm sm:text-base leading-relaxed text-[#64748b] space-y-4">
            <p>
              Non-small cell lung carcinoma is the most common form of lung
              cancer, and treatment decisions depend heavily on how early it's
              caught and what makes the individual tumour tick. Dr. Manish
              Aggarwal builds each treatment plan around the cancer's stage, its
              specific subtype, and the patient's overall fitness for treatment,
              since these factors determine whether surgery is possible or
              whether other approaches take priority.
            </p>
            <p>
              For early-stage disease, surgery often offers the best chance at
              removing the cancer entirely, while more advanced or inoperable
              cases rely on chemotherapy, radiation, targeted therapy, or
              immunotherapy, sometimes in combination, based on molecular
              testing and how the tumour behaves. Since NSCLC treatment often
              combines more than one approach, regular monitoring by your
              Non-Small Cell Lung Carcinoma Specialist helps track response and
          ...
          <div className="mt-10 max-w-3xl mx-auto rounded-3xl bg-slate-50 border border-slate-200 p-6 sm:p-8 text-center flex flex-col items-center">
            ...
            <p className="mt-2 text-sm text-[#64748b] max-w-xl">
              Every case of NSCLC is different, and so is the right treatment
              for it by Dr. Manish Aggarwal, your trusted Non-Small Cell Lung
              Carcinoma Specialist in Delhi.
            </p>
            <div className="mt-6">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 mt-2 items-center">
            <div className="flex-1 order-2 lg:order-1">
              ...
              <p className="text-sm sm:text-base text-[#64748b] leading-relaxed">
                ...
                diagnosing and managing lung cancer, including Non-Small Cell
                Lung Carcinoma. He completed his MBBS and MD in Tuberculosis and
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
              <div className="flex-1">
                ...
                <p className="text-sm sm:text-base text-slate-300 max-w-xl leading-relaxed">
                  Early diagnosis can make all the difference. Get an expert
                  evaluation and a personalised NSCLC treatment plan from Dr.
                  Manish Aggarwal, your trusted Non-Small Cell Lung Carcinoma
                  Specialist in Delhi.
                </p>
              </div>
