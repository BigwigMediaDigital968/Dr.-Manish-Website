...
const faqs = [
  ...
  {
    question:
      "Should I see a specialist if I have a persistent cough with recurrent infections?",
    answer:
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 mt-2">
            <div className="flex-1">
              ...
              <p className="text-sm sm:text-base text-[#64748b] leading-relaxed mt-4">
                A bronchial carcinoid tumor is a rare type of lung tumor that
                develops from hormone-producing cells in the airway lining.
                Unlike more common lung cancers, carcinoid tumors usually grow
                slowly and rarely spread to other parts of the body, which is
                why they're often described as low-grade. They're generally
                classified as typical or atypical, with typical carcinoids
                growing more slowly and atypical ones behaving slightly more
                aggressively.
              </p>

              <p className="text-sm sm:text-base text-[#64748b] leading-relaxed mt-4">
                Because these tumors grow inside the airway, they can sometimes
                block airflow and lead to repeated infections in the affected
                part of the lung. Evaluation by a Bronchial Carcinoid Tumor
                Specialist helps confirm the diagnosis and decide the right
                treatment approach early.
              </p>
            </div>
        ...
        <div className="flex flex-col lg:flex-row gap-12 pt-16 sm:pt-20">
          ...
          <div className="flex-1">
            ...
            <p className="mt-4 text-sm sm:text-base leading-relaxed text-[#64748b]">
              Symptoms often develop gradually and can be mistaken for asthma or
              a lingering chest infection. Common signs include:
            </p>
          ...
          <div className="flex-1">
            ...
            <p className="mt-4 text-sm sm:text-base leading-relaxed text-[#64748b]">
              The exact cause of bronchial carcinoid tumors isn't fully
              understood, but certain factors are associated with a higher risk:
            </p>
        ...
        <section className="pt-10 sm:pt-16">
          ...
          <div className="mt-4 text-sm sm:text-base leading-relaxed text-[#64748b] space-y-4">
            <p>
              Bronchial carcinoid tumors are slow-growing and generally carry a
              better outlook than other lung cancers when caught and treated
              early. Dr. Manish Aggarwal plans treatment around the tumour's
              size, location, and type, particularly whether it's typical or
              atypical, as this shapes both the approach and the risk of
              recurrence.
            </p>
            <p>
              Surgery remains the mainstay of treatment, aiming to remove the
              tumour while preserving healthy lung tissue, though select cases
              may be treated through bronchoscopy instead. Since these tumours
              are slow-growing, long-term follow-up with your Bronchial
              Carcinoid Tumor Specialist helps ensure early detection if it ever
              returns.
            </p>
          </div>
          ...
          <div className="mt-10 max-w-3xl mx-auto rounded-3xl bg-slate-50 border border-slate-200 p-6 sm:p-8 text-center flex flex-col items-center">
            ...
            <p className="mt-2 text-sm text-[#64748b] max-w-xl">
              Every case of bronchial carcinoid tumor is different, and so is
              the right treatment for it by Dr. Manish Aggarwal, your trusted
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 mt-2 items-center">
            <div className="flex-1 order-2 lg:order-1">
              <h2 className="text-2xl sm:text-3xl font-bold text-[#0f172a] mb-4 leading-tight">
                Meet Dr. Manish Aggarwal, Your Bronchial Carcinoid Tumor
                Specialist
              </h2>

              <p className="text-sm sm:text-base text-[#64748b] leading-relaxed">
                Dr. Manish Aggarwal is a pulmonologist with years of experience
                diagnosing and managing lung tumors, including bronchial
                carcinoid tumors. He completed his MBBS and MD in Tuberculosis
                and Chest Diseases from Delhi University, followed by NHS
                clinical experience in the United Kingdom and the prestigious
                FRCP (Glasgow) from the Royal College of Physicians.
              </p>

              <p className="text-sm sm:text-base text-[#64748b] leading-relaxed mt-4">
                He is known for explaining conditions in simple,
                easy-to-understand language and building treatment plans around
                each patient's specific test results, rather than offering a
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
              <div className="flex-1">
                ...
                <p className="text-sm sm:text-base text-slate-300 max-w-xl leading-relaxed">
                  Most bronchial carcinoid tumors are slow-growing and respond
                  very well to treatment. Get an expert diagnosis and a
                  personalised plan from Dr. Manish Aggarwal, your trusted
                  Bronchial Carcinoid Tumor Specialist in Delhi.
                </p>
              </div>
