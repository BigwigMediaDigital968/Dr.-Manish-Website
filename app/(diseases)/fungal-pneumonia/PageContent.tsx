...
const faqs = [
  {
    ...
    answer:
      "Fungal pneumonia develops when a person breathes in fungal spores from the environment, such as soil, dust, or bird and bat droppings. Most healthy people who are exposed don't develop pneumonia, but those with weakened immune systems are far more likely to get infected after exposure.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "People with weakened immune systems are at the highest risk, including those with HIV, cancer patients undergoing chemotherapy, organ transplant recipients, and people on long-term steroid use. People with existing lung conditions, and those living or working in areas with high fungal exposure, such as farming or construction, are also at increased risk.",
  },
  {
    question: "How to tell if pneumonia is bacterial or fungal?",
    answer:
      "Bacterial pneumonia usually comes on suddenly with high fever and thick, discoloured mucus, and improves with antibiotics. Fungal pneumonia tends to develop more slowly, often doesn't respond to antibiotics, and needs specific tests like sputum culture, blood tests, or sometimes a bronchoscopy to identify the fungus. A pulmonologist can confirm the exact cause through proper testing rather than symptoms alone.",
  },
  {
    question: "Is fungal pneumonia contagious?",
    answer:
      "No, fungal pneumonia is generally not contagious from person to person. It's caused by inhaling fungal spores from the environment, not by spread through coughing or close contact, though people with weakened immunity should still take precautions around known high-exposure environments.",
  },
  {
    question: "How long does treatment for fungal pneumonia take?",
    answer:
      "Treatment duration varies depending on the specific fungus and severity of infection, often ranging from several weeks to a few months. Regular follow-up and imaging help Dr. Manish Aggarwal determine when it's safe to stop antifungal treatment.",
  },
];
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 mt-2">
            <div className="flex-1">
              ...
              <p className="text-sm sm:text-base text-[#64748b] leading-relaxed mt-4">
                Fungal pneumonia happens when fungal spores are breathed into
                the lungs and cause an infection or inflammation in the lung
                tissue. Unlike bacterial or viral pneumonia, it doesn't respond
                to antibiotics or antivirals, so it often needs a different
                diagnostic approach and specific antifungal treatment.
              </p>

              <p className="text-sm sm:text-base text-[#64748b] leading-relaxed mt-4">
                Fungal pneumonia is more common in people with weakened immune
                systems, though certain fungi can also affect otherwise healthy
                individuals depending on where they live or work. Without proper
                treatment from a Fungal Pneumonia Specialist, the infection can
                spread and cause lasting lung damage.
              </p>
            </div>
        ...
        <div className="flex flex-col lg:flex-row gap-12 pt-16 sm:pt-20">
          ...
          <div className="flex-1">
            ...
            <p className="mt-4 text-sm sm:text-base leading-relaxed text-[#64748b]">
              Fungal pneumonia symptoms often develop more slowly than bacterial
              pneumonia and can be mistaken for other lung infections. Common
              signs include:
            </p>
          ...
          <div className="flex-1">
            ...
            <p className="mt-4 text-sm sm:text-base leading-relaxed text-[#64748b]">
              Fungal pneumonia develops when fungal spores from the environment
              are inhaled into the lungs. Common causes include:
            </p>
            ...
            <ul className="mt-6 space-y-2 ">
              {[
                {
                  name: "Aspergillus",
                  text: "Found in soil, dust, and decaying matter, one of the more frequent causes of fungal lung infections.",
                },
                {
                  name: "Histoplasma",
                  text: "Common in soil contaminated with bird or bat droppings.",
                },
                {
                  name: "Cryptococcus",
                  text: "Found in soil and bird droppings, particularly affects people with weakened immunity.",
                },
                {
                  name: "Pneumocystis jirovecii",
                  text: "Mainly affects people with significantly weakened immune systems.",
                },
                {
                  name: "Weakened Immunity",
                  text: "From conditions like HIV, cancer treatment, organ transplant, or long-term steroid use, which make the lungs more vulnerable to fungal infection.",
                },
              ].map((cause, index) => (
                <li
                  key={index}
        ...
        <section className="pt-16 sm:pt-20">
          ...
          <p className="mt-4 text-sm sm:text-base leading-relaxed text-[#64748b]">
            Since fungal pneumonia can look similar to bacterial or viral
            pneumonia on the surface, identifying the specific fungus is
            essential before starting the right antifungal treatment. Dr. Manish
        ...
        <section className="pt-16 sm:pt-20">
          ...
          <div className="mt-4 text-sm sm:text-base leading-relaxed text-[#64748b] space-y-4">
            <p>
              Fungal pneumonia is less common than bacterial pneumonia but often
              more challenging to treat, usually affecting people with weakened
              immunity and requiring a longer, more carefully monitored course
              of care. Dr. Manish Aggarwal builds the treatment plan around the
              specific fungus causing the infection, the severity of symptoms,
              and what's driving the patient's lowered immunity in the first
              place.
            </p>
            <p>
              Antifungal medicines form the backbone of treatment, often needed
              for weeks to months rather than days, while oxygen support and
              hospitalisation are reserved for more severe presentations.
              Because the underlying immune issue often needs attention
              alongside the infection itself, care is frequently coordinated
              with other specialists, and regular follow-up ensures the
              infection is fully resolving rather than just improving on the
              surface.
            </p>
          </div>
          ...
          <div className="mt-10 max-w-3xl mx-auto rounded-3xl bg-slate-50 border border-slate-200 p-6 sm:p-8 text-center flex flex-col items-center">
            ...
            <p className="mt-2 text-sm text-[#64748b] max-w-xl">
              Every case of fungal pneumonia is different, and so is the right
              treatment for it by Dr. Manish Aggarwal, your trusted Fungal
              Pneumonia Specialist in Delhi.
            </p>
            <div className="mt-6">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 mt-2 items-center">
            <div className="flex-1 order-2 lg:order-1">
              ...
              <p className="text-sm sm:text-base text-[#64748b] leading-relaxed">
                ...
                including fungal pneumonia. He completed his MBBS and MD in
              ...
              <p className="text-sm sm:text-base text-[#64748b] leading-relaxed mt-4">
                ...
                each patient's specific test results and immune status, rather
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
              <div className="flex-1">
                ...
                <p className="text-sm sm:text-base text-slate-300 max-w-xl leading-relaxed">
                  Fungal pneumonia often gets mistaken for something else; don't
                  wait for it to get worse. Get an expert diagnosis and a
                  personalised treatment plan from Dr. Manish Aggarwal, your
                  trusted Fungal Pneumonia Specialist in Delhi.
                </p>
              </div>
