...
const faqs = [
  {
    ...
    answer:
      "Bronchiectasis is usually caused by repeated or severe lung infections, such as pneumonia or tuberculosis, that damage the airways over time. Underlying conditions like cystic fibrosis, COPD, immune system disorders, or ABPA can also lead to it. In some patients, no clear cause is identified despite thorough testing.",
  },
  {
    question: "Can you live a long life with bronchiectasis?",
    answer:
      "Yes, many people with bronchiectasis live long, active lives, especially when the condition is diagnosed early and managed consistently. Regular airway clearance, timely treatment of flare-ups, and addressing any underlying cause all help slow down further lung damage and maintain a good quality of life.",
  },
  {
    question: "How do you treat bronchiectasis?",
    answer:
      "Treatment usually includes airway clearance techniques to help clear mucus, antibiotics for infections and flare-ups, bronchodilators to ease breathlessness, and pulmonary rehabilitation to build stamina. If an underlying cause is identified, treating that condition is also an important part of the plan. Dr. Manish Aggarwal tailors the combination based on each patient's specific case.",
  },
  {
    question: "What is the difference between bronchitis and bronchiectasis?",
    answer:
      "Bronchitis is inflammation of the airways that is often temporary, especially in acute cases caused by an infection, though chronic bronchitis can be long-lasting. Bronchiectasis, on the other hand, involves permanent widening and scarring of the airways, which doesn't reverse and requires ongoing management. A pulmonologist can tell the two apart through imaging and other tests.",
  },
  {
    question: "Is bronchiectasis the same as COPD?",
    answer:
      "No, though the two can occur together. COPD mainly involves narrowed airways and damaged air sacs, usually from smoking, while bronchiectasis involves widened, scarred airways, often from infections or other underlying conditions. Some patients have features of both, so proper evaluation is important.",
  },
  {
    question: "Can bronchiectasis be cured?",
    answer:
      "Bronchiectasis cannot be cured, since the airway damage is permanent, but it can be managed very effectively. With the right treatment plan and regular follow-up, most patients can reduce flare-ups and maintain good lung function for years.",
  },
];
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 mt-2">
            <div className="flex-1">
              ...
              <p className="text-sm sm:text-base text-[#64748b] leading-relaxed mt-4">
                Bronchiectasis happens when the airways in the lungs become
                permanently widened and scarred, usually due to repeated
                infections or inflammation over time. This damage makes it
                harder for the airways to clear mucus naturally, so it builds up
                and becomes a breeding ground for further infections, creating a
                cycle that can worsen lung function if left unmanaged.
              </p>

              <p className="text-sm sm:text-base text-[#64748b] leading-relaxed mt-4">
                Bronchiectasis cannot be reversed, but with the right care from
                a Bronchiectasis Specialist, symptoms can be controlled, and
                further lung damage slowed significantly.
              </p>
            </div>
        ...
        <div className="flex flex-col lg:flex-row gap-12 pt-16 sm:pt-20">
          ...
          <div className="flex-1">
            ...
            <p className="mt-4 text-sm sm:text-base leading-relaxed text-[#64748b]">
              Bronchiectasis symptoms tend to develop gradually and often get
              mistaken for chronic bronchitis or a lingering chest infection.
          ...
          <div className="flex-1">
            ...
            <p className="mt-4 text-sm sm:text-base leading-relaxed text-[#64748b]">
              Bronchiectasis develops when the airways are damaged, often due to
              an underlying condition or repeated infections. Common causes
              include:
            </p>
        ...
        <section className="pt-16 sm:pt-20">
          ...
          <p className="mt-4 text-sm sm:text-base leading-relaxed text-[#64748b]">
            Confirming bronchiectasis and identifying its underlying cause helps
            guide the right long-term treatment plan. Dr. Manish Aggarwal uses
            the following tests:
          </p>
        ...
        <section className="pt-16 sm:pt-20">
          ...
          <div className="mt-4 text-sm sm:text-base leading-relaxed text-[#64748b] space-y-4">
            <p>
              Bronchiectasis develops when the airways become permanently
              widened and scarred, making them prone to mucus buildup and
              repeated infections. Dr. Manish Aggarwal shapes the treatment plan
              around what's driving the condition, how severe it is, and how
              often flare-ups occur, since managing the underlying cause is just
              as important as controlling day-to-day symptoms.
            </p>
            <p>
              Core treatment usually centres on clearing mucus regularly and
              preventing infections, supported by inhalers for easier breathing
              and rehabilitation to build overall stamina. Surgery remains a
              rare option, reserved for select cases where damage is localised.
              Since bronchiectasis is a long-term condition, regular monitoring
              by your Bronchiectasis Specialist helps catch flare-ups early and
          ...
          <div className="mt-10 max-w-3xl mx-auto rounded-3xl bg-slate-50 border border-slate-200 p-6 sm:p-8 text-center flex flex-col items-center">
            ...
            <p className="mt-2 text-sm text-[#64748b] max-w-xl">
              Every case of bronchiectasis is different, and so is the right
              treatment for it by Dr. Manish Aggarwal, your trusted
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 mt-2 items-center">
            <div className="flex-1 order-2 lg:order-1">
              ...
              <p className="text-sm sm:text-base text-[#64748b] leading-relaxed">
                ...
                including bronchiectasis. He completed his MBBS and MD in
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
              <div className="flex-1">
                ...
                <p className="text-sm sm:text-base text-slate-300 max-w-xl leading-relaxed">
                  Get an expert diagnosis and a personalised bronchiectasis
                  treatment plan from Dr. Manish Aggarwal, your trusted
                  Bronchiectasis Specialist in Delhi.
                </p>
              </div>
