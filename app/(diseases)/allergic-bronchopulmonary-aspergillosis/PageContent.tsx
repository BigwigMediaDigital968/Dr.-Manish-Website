...
const faqs = [
  {
    question:
      "What medication is used for allergic bronchopulmonary aspergillosis?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Yes, though it is more commonly seen in children and adults who have underlying asthma or cystic fibrosis. Symptoms and treatment Principals are similar, but dosing and monitoring are adjusted for children.",
  },
  {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 mt-2">
            <div className="flex-1">
              ...
              <p className="text-sm sm:text-base text-[#64748b] leading-relaxed mt-4">
                Allergic Bronchopulmonary Aspergillosis happens when your immune
                system overreacts to a fungus called Aspergillus, found almost
                everywhere in soil, dust, and the air we breathe. Most healthy
                people breathe it in without any issue, but in some patients,
                especially those with asthma or cystic fibrosis, the immune
                system treats this fungus as a threat, triggering ongoing
                inflammation in the airways and lungs.
              </p>

              <p className="text-sm sm:text-base text-[#64748b] leading-relaxed mt-4">
                This is not an infection in the usual sense, the fungus does not
                spread through the body; it simply triggers a strong allergic
                reaction inside the lungs. Without proper treatment from an
                Allergic Bronchopulmonary Aspergillosis Specialist, this ongoing
                inflammation can permanently scar the airways.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="pt-16 sm:pt-20">
          ...
          <p className="mt-4 text-sm sm:text-base leading-relaxed text-[#64748b]">
            ABPA symptoms often overlap with poorly controlled asthma, which is
            why it can go undiagnosed for a while. Common signs include:
          </p>
        ...
        <section className="pt-16 sm:pt-20">
          ...
          <p className="mt-4 text-sm sm:text-base leading-relaxed text-[#64748b]">
            ABPA develops when the immune system overreacts to the Aspergillus
            fungus. Common risk factors include:
          </p>

          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                title: "Underlying Asthma",
                text: "Most ABPA patients already have asthma.",
              },
              {
                title: "Cystic Fibrosis",
                text: "Another major risk factor for developing ABPA.",
              },
              {
                title: "Environmental Exposure",
                text: "Aspergillus is common in soil, dust, and decaying matter, so frequent exposure increases risk.",
              },
              {
                title: "Hyper-Reactive Immunity",
                text: "Some patients have an immune system that reacts more strongly to the fungus than others.",
              },
            ].map((cause, index) => (
              <div
                key={index}
        ...
        <section className="pt-16 sm:pt-20">
          ...
          <h2 className="mt-2 text-2xl sm:text-3xl font-bold text-[#0f172a] leading-tight">
            Why are Diagnostic Tests for Allergic Bronchopulmonary Aspergillosis
            important
          </h2>

          <p className="mt-4 text-sm sm:text-base leading-relaxed text-[#64748b]">
            Confirming that your symptoms are actually caused by ABPA, and not
            by asthma or a chest infection alone, is the first and most
            important step. A correct diagnosis avoids unnecessary treatment and
            ensures the right care plan from the start.
          </p>

          <p className="mt-4 text-sm sm:text-base font-semibold text-[#0f172a]">
            Dr. Manish Aggarwal uses the following tests to accurately profile
          ...
          <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            {[
              ...
              { name: "FeNO", link: "/procedures/feno-test-in-delhi" },
            ].map((test, index) =>
              test.link ? (
                <Link
                  key={index}
        ...
        <section className="pt-16 sm:pt-20">
          ...
          <div className="mt-4 text-sm sm:text-base leading-relaxed text-[#64748b] space-y-4">
            <p>
              ABPA is a complex condition where the body's immune system
              overreacts to a fungus commonly present in the air, leading to
              persistent inflammation and mucus buildup in the airways. Because
              the disease behaves differently from patient to patient, Dr.
              Manish Aggarwal designs each treatment plan around symptom
              severity and how well the body responds to initial therapy,
              adjusting the approach over time rather than following a fixed
              protocol.
            </p>
            <p>
              Treatment typically works on two fronts at once, calming
              inflammation with steroids while tackling the underlying fungal
              trigger with antifungal medicines alongside supportive care like
              inhalers and physiotherapy to ease daily breathing. Since ABPA
              tends to relapse, this combined approach is designed for the long
              haul, not just short-term relief.
            </p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 mt-2 items-center">
            <div className="flex-1 order-2 lg:order-1">
              <h2 className="text-2xl sm:text-3xl font-bold text-[#0f172a] mb-4 leading-tight">
                About Dr. Manish Aggarwal - Allergic Bronchopulmonary
                Aspergillosis Specialist in Delhi
              </h2>
              ...
              <p className="text-sm sm:text-base text-[#64748b] leading-relaxed">
                ...
                including Allergic Bronchopulmonary Aspergillosis. He completed
                his MBBS and MD in Tuberculosis and Chest Diseases from Delhi
                University, followed by NHS clinical experience in the United
                Kingdom and the prestigious FRCP (Glasgow) from the Royal
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
              <div className="flex-1">
                ...
                <p className="text-sm sm:text-base text-slate-300 max-w-2xl leading-relaxed">
                  Get an accurate diagnosis and a treatment plan built around
                  you, from Dr. Manish Aggarwal, your trusted Allergic
                  Bronchopulmonary Aspergillosis Specialist in Delhi.
                </p>
              </div>
