...
const faqs = [
  {
    ...
    answer:
      "ILD can be caused by autoimmune diseases, long-term exposure to dust or chemicals, certain medications, or previous radiation therapy. In many cases, especially idiopathic pulmonary fibrosis, no specific cause is found despite thorough testing.",
  },
  {
    question: "Can Interstitial Lung Disease be cured?",
    answer:
      "ILD cannot be cured, since the scarring in the lung tissue is permanent, but treatment can slow down its progression and manage symptoms effectively. Many patients maintain a good quality of life for years with the right ongoing care.",
  },
  {
    question: "How serious is lung fibrosis?",
    answer:
      "Lung fibrosis can range from mild, slowly progressing cases to severe forms that significantly affect breathing and daily activity. The outlook depends on the type of ILD, how early it's diagnosed, and how the patient responds to treatment, which is why early evaluation by an Interstitial Lung Disease Specialist matters.",
  },
  {
    question:
      "What is the life expectancy for someone with Interstitial Lung Disease?",
    answer:
  ...
  {
    question:
      "When should I see a specialist for breathlessness or a persistent cough?",
    answer:
      "If you have breathlessness that keeps getting worse over weeks or months, or a dry cough that doesn't go away, it's worth getting evaluated by a pulmonologist. Early diagnosis of ILD makes a significant difference in how well the condition can be managed long-term.",
  },
];
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 mt-2">
            <div className="flex-1">
              ...
              <p className="text-sm sm:text-base text-[#64748b] leading-relaxed mt-4">
                Interstitial Lung Disease is an umbrella term for a large group
                of conditions that cause scarring, or fibrosis, in the tissue
                surrounding the lungs' air sacs. As this scarring builds up, the
                lungs become stiffer and less able to expand, making it harder
                for oxygen to pass into the blood. This is why breathlessness is
                usually the first noticeable symptom.
              </p>

              <p className="text-sm sm:text-base text-[#64748b] leading-relaxed mt-4">
                ILD can be caused by a known trigger or, in many cases, no clear
                cause is ever found, which is called idiopathic pulmonary
                fibrosis. Without proper treatment from an Interstitial Lung
                Disease Specialist, the scarring can continue to progress and
                permanently reduce lung function.
              </p>
            </div>
        ...
        <div className="flex flex-col lg:flex-row gap-12 pt-16 sm:pt-20">
          ...
          <div className="flex-1">
            ...
            <p className="mt-4 text-sm sm:text-base leading-relaxed text-[#64748b]">
              ILD symptoms usually develop slowly over months or years, which
          ...
          <div className="flex-1">
            ...
            <p className="mt-4 text-sm sm:text-base leading-relaxed text-[#64748b]">
              ILD can be triggered by a wide range of factors, though in many
              patients no clear cause is ever identified. Common causes include:
            </p>
              ...
              {[
                {
                  ...
                  text: "Such as rheumatoid arthritis, scleroderma, and lupus, which can cause lung scarring.",
                },
                {
                  name: "Occupational & Environmental Exposure",
                  text: "Long-term exposure to asbestos, silica dust, coal dust, or bird droppings.",
                },
                {
                  name: "Certain Medications",
                  text: "Some chemotherapy drugs, heart medicines, and other long-term treatments can affect lung tissue.",
                },
                {
                  name: "Radiation Therapy",
                  text: "Previous radiation to the chest can lead to scarring over time.",
                },
                {
                  name: "Idiopathic (Unknown) Causes",
                  text: "In many cases, especially idiopathic pulmonary fibrosis, no specific trigger is found despite thorough testing.",
                },
                {
                  name: "Genetic Factors",
                  text: "A family history of pulmonary fibrosis increases the risk in some patients.",
                },
              ].map((cause, index) => (
                <li
                  key={index}
        ...
        <section className="pt-16 sm:pt-20">
          ...
          <p className="mt-4 text-sm sm:text-base leading-relaxed text-[#64748b]">
            Identifying ILD, and telling it apart from other lung conditions, is
            essential for choosing the right treatment approach early. Dr.
            Manish Aggarwal uses the following tests:
          </p>
          ...
          <ul className="mt-6 space-y-3">
            {[
              ...
              },
              {
                ...
                link: "/procedures/bronchoalveolar-lavage-bal-in-delhi",
              },
            ].map((test, index) => (
              <li
                key={index}
        ...
        <section className="pt-16 sm:pt-20">
          ...
          <div className="mt-4 text-sm sm:text-base leading-relaxed text-[#64748b] space-y-4">
            <p>
              Interstitial lung disease covers a wide group of conditions where
              the lung tissue becomes scarred or inflamed, and no two cases
              follow quite the same path. Dr. Manish Aggarwal tailors the
              treatment plan to the specific type of ILD, what's driving it, and
              how far the scarring has progressed, since a fibrosis-driven case
              and an autoimmune-linked one often call for very different
              approaches.
            </p>
            <p>
              Depending on the underlying cause, treatment may focus on slowing
              further scarring, calming inflammation, or addressing the root
              condition itself, alongside oxygen support and rehabilitation to
              help with daily breathing and stamina. In advanced cases where
              these measures reach their limit, a lung transplant may be
              considered. Since ILD often progresses gradually, regular
              monitoring by your Interstitial Lung Disease Specialist helps
              track lung function over time and adjust the treatment plan as
              needed.
            </p>
          </div>
          ...
          <div className="mt-10 max-w-3xl mx-auto rounded-3xl bg-slate-50 border border-slate-200 p-6 sm:p-8 text-center flex flex-col items-center">
            ...
            <p className="mt-2 text-sm text-[#64748b] max-w-xl">
              Every case of ILD is different, and so is the right treatment for
              it by Dr. Manish Aggarwal, your trusted Interstitial Lung Disease
              Specialist in Delhi.
            </p>
            <div className="mt-6">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 mt-2 items-center">
            <div className="flex-1 order-2 lg:order-1">
              ...
              <p className="text-sm sm:text-base text-[#64748b] leading-relaxed">
                ...
                diagnosing and treating lung and breathing-related conditions,
                including Interstitial Lung Disease and lung fibrosis. He
                completed his MBBS and MD in Tuberculosis and Chest Diseases
                from Delhi University, followed by NHS clinical experience in
                the United Kingdom and the prestigious FRCP (Glasgow) from the
              ...
              <p className="text-sm sm:text-base text-[#64748b] leading-relaxed mt-4">
                ...
                each patient's specific test results and symptoms, rather than
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
              <div className="flex-1">
                ...
                <p className="text-sm sm:text-base text-slate-300 max-w-xl leading-relaxed">
                  Don't wait for breathlessness to worsen. Get an expert
                  diagnosis and a personalised ILD treatment plan from Dr.
                  Manish Aggarwal, your trusted Interstitial Lung Disease
                  Specialist in Delhi.
                </p>
              </div>
