    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-4">
            <div className="rounded-3xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm">
              ...
              <p className="text-sm sm:text-base text-[#64748b] leading-relaxed">
                Uncontrolled asthma means your symptoms, such as wheezing,
                coughing, or breathlessness, are not being managed well, even
                though your asthma itself may not be severe. This usually
                happens due to incorrect inhaler technique, missed doses,
                exposure to triggers, or an inhaler that isn't strong enough for
                your current symptoms. The good news is that uncontrolled asthma
                can often be brought back under control once the underlying
                reason is identified and corrected.
              </p>
            </div>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm">
              ...
              <p className="text-sm sm:text-base text-[#64748b] leading-relaxed">
                Severe asthma is a specific type of asthma that stays difficult
                to control even when the patient is using high-dose inhalers
                correctly and following the treatment plan exactly as
                prescribed. Unlike uncontrolled asthma, severe asthma often
                needs additional treatments beyond standard inhalers, such as
                biologic therapy, to bring symptoms under control.
              </p>
            </div>
          </div>
        </section>
            ...
            <table className="w-full text-left border-collapse bg-white text-sm sm:text-base">
              <thead>
                <tr className="bg-slate-50 border-b border-slate-200">
                  <th className="p-4 font-bold text-[#0f172a] w-[25%]">
                    Factor
                  </th>
                  <th className="p-4 font-bold text-[#0f172a] w-[37.5%]">
                    Uncontrolled Asthma
                  </th>
                  <th className="p-4 font-bold text-[#0f172a] w-[37.5%]">
                    Severe Asthma
              ...
              <tbody className="divide-y divide-slate-200 text-[#64748b] text-xs sm:text-sm">
                <tr>
                  <td className="p-4 font-semibold text-[#0f172a] bg-slate-50/50">
                    Cause of poor control
                  </td>
                  <td className="p-4">
                    Fixable factors like inhaler technique or missed doses
                  </td>
                  <td className="p-4">
                    Stays poorly controlled despite correct treatment
                  </td>
                </tr>
                <tr>
                  <td className="p-4 font-semibold text-[#0f172a] bg-slate-50/50">
                  ...
                  <td className="p-4">
                    Often improves once the issue is corrected
                  </td>
                  <td className="p-4">
                    Does not respond well even to high-dose standard medication
                  </td>
                </tr>
                <tr>
                  <td className="p-4 font-semibold text-[#0f172a] bg-slate-50/50">
                  ...
                  <td className="p-4">
                    Technique correction, trigger avoidance, or dose adjustment
                  </td>
                  <td className="p-4">
                    Specialised tests and advanced treatments like biologics
                  </td>
                </tr>
                <tr>
                  <td className="p-4 font-semibold text-[#0f172a] bg-slate-50/50">
                  ...
                  <td className="p-4">
                    Identified by checking technique, adherence, and triggers
                  </td>
                  <td className="p-4">
                    Confirmed only after ruling out all fixable causes of
                    uncontrolled asthma
                  </td>
                </tr>
              </tbody>
        ...
        <div className="flex flex-col lg:flex-row gap-12 pt-16 sm:pt-20">
          ...
          <div className="flex-1">
            ...
            <p className="mt-4 text-sm sm:text-base leading-relaxed text-[#64748b]">
              Uncontrolled Asthma and Severe Asthma conditions can present with
              similar day-to-day symptoms, which is why a proper evaluation
              matters:
            </p>
          ...
          <div className="flex-1">
            ...
            <p className="mt-4 text-sm sm:text-base leading-relaxed text-[#64748b]">
              Different factors can push asthma toward being uncontrolled or
              push it into the severe category:
            </p>

            <div className="mt-6 space-y-4">
              {[
                {
                  title: "Poor Inhaler Technique",
                  desc: "A leading cause of uncontrolled asthma.",
                },
                {
                  title: "Missed or Irregular Medication",
                  desc: " Skipping doses reduces long-term control.",
                },
                {
                  title: "Ongoing Exposure to Triggers",
                  desc: "Dust, pollen, smoke, or pollution.",
                },
                {
                  title: "Undiagnosed Coexisting Conditions",
                  desc: "Such as allergic rhinitis or GERD, which can worsen asthma control.",
                },
                {
                  title: "Underlying Airway Inflammation Type",
                  desc: "Certain patients have an inflammation pattern that doesn't respond well to standard inhalers, a hallmark of severe asthma.",
                },
              ].map((item, index) => (
                <div
                  key={index}
        ...
        <section className="pt-16 sm:pt-20">
          ...
          <p className="mt-4 text-sm sm:text-base leading-relaxed text-[#64748b]">
            Before deciding whether you have Uncontrolled Asthma vs Severe
            Asthma, Dr. Manish Aggarwal reviews your inhaler technique,
            medication history, and trigger exposure, along with the following
            tests:
          </p>
          ...
          <div className="mt-8 grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { name: "PFT (Pulmonary Function Test)", href: "/procedures/pulmonary-function-test-pft-in-delhi" },
              { name: "FeNO Testing", href: "/procedures/feno-test-in-delhi" },
        ...
        <section className="pt-16 sm:pt-20">
          ...
          <div className="mt-4 text-sm sm:text-base leading-relaxed text-[#64748b] space-y-4">
            <p>
              Not every case of "uncontrolled asthma" is actually severe asthma;
              often, symptoms persist simply because of inhaler technique,
              unaddressed triggers, or overlooked conditions like allergies or
              acid reflux. Dr. Manish Aggarwal's approach starts by separating
              these fixable factors from true severe asthma before deciding on
              next steps, since jumping straight to stronger treatment can mean
              over-medicating a problem that a simple correction could have
              solved.
            </p>
            <p>
              Once the real cause of poor control is identified, the plan is
              adjusted accordingly, ranging from basic corrections to targeted
              biologic therapy for confirmed severe cases, with regular
              monitoring to keep the Uncontrolled Asthma vs Severe Asthma
              treatment aligned with how the condition evolves.
            </p>
          </div>
          ...
          <div className="mt-10 max-w-3xl mx-auto rounded-3xl bg-slate-50 border border-slate-200 p-6 sm:p-8 text-center flex flex-col items-center">
            ...
            <p className="mt-2 text-sm sm:text-base text-[#64748b] leading-relaxed max-w-xl">
              Uncontrolled Asthma vs Severe Asthma need very different
              approaches. Get an accurate evaluation from Dr. Manish Aggarwal.
            </p>
            <div className="mt-6">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 mt-2 items-center">
            <div className="flex-1 order-2 lg:order-1">
              <h2 className="text-2xl sm:text-3xl font-bold text-[#0f172a] mb-4 leading-tight">
                Your Uncontrolled & Severe Asthma Specialist – Dr. Manish
                Aggarwal
              </h2>

              <p className="text-sm sm:text-base text-[#64748b] leading-relaxed">
                Dr. Manish Aggarwal is a pulmonologist with years of experience
                diagnosing and treating asthma, including complex and severe
                cases. He completed his MBBS and MD in Tuberculosis and Chest
                Diseases from Delhi University, followed by NHS clinical
              ...
              <p className="text-sm sm:text-base text-[#64748b] leading-relaxed mt-4">
                ...
                each patient's specific triggers, test results, and response to
                medication, rather than offering a one-size-fits-all approach.
              </p>
            </div>
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
              <div className="flex-1">
                ...
                <p className="text-sm sm:text-base text-slate-300 max-w-xl leading-relaxed">
                  Book a consultation with Dr. Manish Aggarwal to find out
                  exactly what's keeping your asthma from being controlled.
                </p>
              </div>
