        ...
        <article className="bg-white border border-slate-200/50 p-6 sm:p-12 rounded-[40px] shadow-sm space-y-12 text-slate-700 text-xs sm:text-sm leading-relaxed text-justify print-full-width">
          ...
          <section className="space-y-4">
            <h2 className="text-xl sm:text-2xl font-black text-slate-900 tracking-tight leading-none">
              Welcome to Delhi Lung & Sleep Centre
            </h2>
          ...
          >
            ...
            <p>
              Delhi Lung & Sleep Centre operates under strict medical safety
              frameworks. Zero tolerance is maintained against verbal abuse,
              physical threat, or disrespectful behavior towards clinical
          ...
          >
            ...
            <p>
              Delhi Lung & Sleep Centre, its directors (including Dr. Manish
              Aggarwal), and its associate clinicians shall not be liable for
